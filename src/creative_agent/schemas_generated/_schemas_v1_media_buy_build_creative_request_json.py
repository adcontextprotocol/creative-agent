...
class SourceFormatId(BaseModel):
...
class BuildCreativeRequest(BaseModel):
    ...
    source_format_id: Annotated[
        Optional[SourceFormatId],
        Field(
    ...
    assets: Annotated[
        Optional[list[Asset]],
        Field(
            description="Available assets to use in creative generation - this is where promoted_offerings should be included as an asset"
        ),
    ] = None
