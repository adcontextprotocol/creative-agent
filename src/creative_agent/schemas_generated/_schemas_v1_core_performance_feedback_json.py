...
class MeasurementPeriod(BaseModel):
    ...
    start: Annotated[
        AwareDatetime,
        Field(description="ISO 8601 start timestamp for measurement period"),
    ]
    end: Annotated[
        AwareDatetime,
        Field(description="ISO 8601 end timestamp for measurement period"),
    ]
...
class PerformanceFeedback(BaseModel):
    ...
    feedback_id: Annotated[
        str,
        Field(description="Unique identifier for this performance feedback submission"),
    ]
    ...
    creative_id: Annotated[
        Optional[str],
        Field(description="Specific creative asset (if feedback is creative-specific)"),
    ] = None
    ...
    metric_type: Annotated[
        MetricType, Field(description="The business metric being measured")
    ]
    feedback_source: Annotated[
        FeedbackSource, Field(description="Source of the performance data")
    ]
    status: Annotated[
        Status, Field(description="Processing status of the performance feedback")
    ]
    submitted_at: Annotated[
        AwareDatetime,
        Field(description="ISO 8601 timestamp when feedback was submitted"),
    ]
