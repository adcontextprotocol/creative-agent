...
class Filters(BaseModel):
    ...
    is_fixed_price: Annotated[
        Optional[bool], Field(description="Filter for fixed price vs auction products")
    ] = None
    format_types: Annotated[
        Optional[list[FormatType]], Field(description="Filter by format types")
    ] = None
    format_ids: Annotated[
        Optional[list[str]], Field(description="Filter by specific format IDs")
    ] = None
    standard_formats_only: Annotated[
        Optional[bool],
        Field(description="Only return products accepting IAB standard formats"),
    ] = None
...
class GetProductsRequest1(BaseModel):
    ...
    filters: Annotated[
        Optional[Filters], Field(description="Structured filters for product discovery")
    ] = None
...
class GetProductsRequest2(BaseModel):
    ...
    filters: Annotated[
        Optional[Filters1],
        Field(description="Structured filters for product discovery"),
    ] = None
