...
#   timestamp: 2025-10-13T06:00:04+00:00
...
class AggregatedTotals(BaseModel):
    ...
    impressions: Annotated[
        float,
        Field(description="Total impressions delivered across all media buys", ge=0.0),
    ]
    spend: Annotated[
        float, Field(description="Total amount spent across all media buys", ge=0.0)
    ]
    clicks: Annotated[
        Optional[float],
...
class DailyBreakdownItem(BaseModel):
    ...
    date: Annotated[
        str, Field(description="Date (YYYY-MM-DD)", pattern="^\\d{4}-\\d{2}-\\d{2}$")
    ]
...
class MediaBuyDelivery(BaseModel):
    ...
    buyer_ref: Annotated[
        Optional[str],
        Field(description="Buyer's reference identifier for this media buy"),
    ] = None
    status: Annotated[
        Status,
        Field(
    ...
    by_package: Annotated[
        list[ByPackageItem], Field(description="Metrics broken down by package")
    ]
    daily_breakdown: Annotated[
        Optional[list[DailyBreakdownItem]], Field(description="Day-by-day delivery")
    ] = None
...
class GetMediaBuyDeliveryResponse(BaseModel):
    ...
    currency: Annotated[
        str, Field(description="ISO 4217 currency code", pattern="^[A-Z]{3}$")
    ]
