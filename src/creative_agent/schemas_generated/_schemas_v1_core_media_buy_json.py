...
class Package(BaseModel):
    ...
    status: Annotated[
        Status3, Field(description="Status of a package", title="Package Status")
    ]
...
class MediaBuy(BaseModel):
    ...
    status: Annotated[
        Status, Field(description="Status of a media buy", title="Media Buy Status")
    ]
    ...
    packages: Annotated[
        list[Package], Field(description="Array of packages within this media buy")
    ]
    creative_deadline: Annotated[
        Optional[AwareDatetime],
        Field(description="ISO 8601 timestamp for creative upload deadline"),
    ] = None
    created_at: Annotated[
        Optional[AwareDatetime], Field(description="Creation timestamp")
    ] = None
    updated_at: Annotated[
        Optional[AwareDatetime], Field(description="Last update timestamp")
    ] = None
