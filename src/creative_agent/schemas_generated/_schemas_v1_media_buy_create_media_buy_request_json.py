...
class CreateMediaBuyRequest1(BaseModel):
    ...
    packages: Annotated[
        list[Union[Packages, Packages1]],
        Field(description="Array of package configurations"),
    ]
    ...
    po_number: Annotated[
        Optional[str], Field(description="Purchase order number for tracking")
    ] = None
...
class CreateMediaBuyRequest2(BaseModel):
    ...
    packages: Annotated[
        list[Union[Packages2, Packages3]],
        Field(description="Array of package configurations"),
    ]
    brand_manifest: Annotated[
...
class CreateMediaBuyRequest(
    RootModel[Union[CreateMediaBuyRequest1, CreateMediaBuyRequest2]]
):
    root: Annotated[
